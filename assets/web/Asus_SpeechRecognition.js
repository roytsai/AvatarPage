...
class speechRecognition {
    ...
    process_message(received_msg){
        ...
        if (received_msg !== ""){
            ...
            else if (received_msg.includes("server_status")){
                final_dic["server_status"] = JSONObject['server_status']
                self.callback(final_dic)
            }
            ...
            if (received_msg.includes("tts_sentence")){
                ...
                if (received_msg.includes("education_type")){
                    final_dic["education_type"] = JSONObject['education_type']
                }
                self.callback(final_dic)
            }
